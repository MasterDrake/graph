...
template < class MutableGraph > void modify_demo(MutableGraph& g)
{
    ...
    }
    {
        ...
        eastl::tie(e, added) = add_edge(u, v, g);
    ...
    }
    {
        ...
        eastl::tie(iter, iter_end) = out_edges(u, g);
    ...
    {
        w = add_vertex(g);
        eastl::tie(e1, added) = add_edge(u, v, g);
        eastl::tie(e2, added) = add_edge(v, w, g);
        name_map[e1] = "I-5";
    ...
    {
        eastl::tie(e1, added) = add_edge(u, v, g);
        eastl::tie(e2, added) = add_edge(u, w, g);
        name_map[e1] = "foo";
        name_map[e2] = "foo";
    ...
    {
        eastl::tie(e1, added) = add_edge(u, v, g);
        eastl::tie(e2, added) = add_edge(w, v, g);
        name_map[e1] = "bar";
        name_map[e2] = "bar";
    ...
    }
    {
        ...
        for (eastl::tie(vi, vi_end) = vertices(g); vi != vi_end; ++vi)
        {
            ...
            for (eastl::tie(ai, ai_end) = adjacent_vertices(*vi, g);
                 ai != ai_end; ++ai)
                assert(*ai != u);
        }
    }
