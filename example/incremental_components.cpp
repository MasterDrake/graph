...
int main(int argc, char* argv[])
{
    ...
    eastl::tie(edge, flag) = add_edge(0, 1, graph);
    ds.union_set(0, 1);

    eastl::tie(edge, flag) = add_edge(1, 4, graph);
    ds.union_set(1, 4);

    eastl::tie(edge, flag) = add_edge(4, 0, graph);
    ds.union_set(4, 0);

    eastl::tie(edge, flag) = add_edge(2, 5, graph);
    ds.union_set(2, 5);
